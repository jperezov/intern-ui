/**
 * This is a file you'll actually want to use as-is. It maps several commands
 * used by Leadfoot when doing functional testing.
 * @see /tests/functional/template/login.js
 */
define(function() {
    return {
